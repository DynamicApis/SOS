...
Provide easy to read and understand REST service documentation format.
...
Documentation should be very easy for a developer to read and quickly make sense of in its raw format. It should also certainly be flexible and simple enough to be easily leveraged by ANY modern user interface.
